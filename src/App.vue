                ...
                webSocket.onmessage = function(d){
                    ...
                    switch (num){
                        ...
                        case '20044':
                                ...
                                if($idIndex != 0){
                                    $this.upLink = 'http://expo.ofweek.com/wap/booth/enter.xhtml?boothId='+$this.exhibitorList[$idIndex-1].boothId+'&mode=2'
                                }

                                if($idIndex != $this.exhibitorList.length - 1){
                                    $this.downLink = 'http://expo.ofweek.com/wap/booth/enter.xhtml?boothId='+$this.exhibitorList[$idIndex+1].boothId+'&mode=2'
                                }
                            break
                        //公司名片消息
                        case '20036':
                        ...
                        case '20043':
                            ...
                            if($this.isLogin==1){
                                pHistoryurl = getString('0075',{"receiverId":arr[0].id,"start":$this.startNum,"size":20})    
                            }else{
                                pHistoryurl = getString('0077',{"receiverId":arr[0].id,"start":$this.startNum,"size":20})  
                            }
                        ...
                        case '20067':
                                ...
                                if(isType == 1){
                                    console.log('留言成功')
                                    var arr1 = {"content":data.body.user.name+'提交了新的留言',"author":{"name":''}}
                                    $this.message.push(arr1)
                                }
                                if(isType == 2){
                                    console.log('样品申请')
                                    $this.message.push({"content":data.body.user.name+'申请了样品',"author":{"name":''}})
                                }

                                if(isType == 3){
                                    console.log('资料下载')
                                    $this.message.push({"content":data.body.user.name+'下载了资料',"author":{"name":''}})
                                }

                                if(isType == 4){
                                    console.log('点赞')
                                    $this.message.push({"content":data.body.user.name+'给展台点了一个赞！',"author":{"name":''}})
                                }

                                if(isType == 5){
                                    console.log('名片交换')
                                    $this.message.push({"content":data.body.user.name+'交换了名片',"author":{"name":''}})
                                }
                        ...
                        //用户进入展台
                        case '20025':
                            $this.message.push({"content":data.body.user.name+'进入了展台',"author":{"name":''}})
                            break
                    }
                }
            }
